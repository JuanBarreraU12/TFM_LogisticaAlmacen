...
export class ListOrdesComponent implements OnInit {
  ...
  constructor( private OrdersService: OrdersService,
    ...
    this.OrdersService.getOrders().subscribe(orders => {this.orderdata = orders;})
...
updateState(pId: Number, pState: Number){
  ...
  this.OrdersService.updateState(pId, pState).then((response) => {
  ...
  capturar() {
    ...
    else if(this.verSeleccion == '0' || this.verSeleccion =='' || this.verSeleccion == null || this.verSeleccion == undefined){
