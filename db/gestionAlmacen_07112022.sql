CREATE DATABASE  IF NOT EXISTS `gestion_almacen` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `gestion_almacen`;
...
CREATE TABLE `orders_details` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_materials_locations_has_orders_materials_locations1` (`materials_locations_id`),
...
-- Dump completed on 2022-11-07 19:26:06
