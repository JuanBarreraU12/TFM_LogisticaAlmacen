...
INSERT INTO `locations` VALUES (1,'Localización 1 ',1),(2,'Localización 2 ',1),(3,'Localización 3',1),(4,'Localización 4 ',2),(5,'Localización 5',2),(6,'Localización 6',2),(13,'Localización 7',9),(17,'Localización 8',9);
...
INSERT INTO `materials_locations` VALUES (1,2,1,25),(5,9,1,25),(6,2,3,12),(7,9,5,25),(9,11,6,125),(10,11,1,300),(12,11,5,150),(13,3,13,85),(14,3,17,150);
...
INSERT INTO `order_states` VALUES (1,'Entered'),(2,'For Review'),(3,'Returned'),(4,'For Delivery'),(5,'Shiped'),(6,'Delivered');
...
INSERT INTO `orders` VALUES (18,'2022-12-10','LKH-7854','Recibido',6,2,1),(19,'2022-12-10','HGF-4169','New order to Juan Carlos',2,2,9),(20,'2022-12-10','KLU-478','Recibido',6,2,9),(21,'2022-12-11','HGF-416','Sin artículos',3,9,1),(24,'2022-12-11','LKH-7854','Recibida',6,1,2),(25,'2022-12-11','JUL-789','Corregido',2,1,9),(46,'2022-12-11','JUL-789','Falta de detalles',2,1,9),(49,'2022-12-28','JUL-789','Para entrega',5,1,2),(60,'2022-12-23','JUL-789','Recibido',6,1,9),(61,'2022-12-15','LKH-7854','Sin artículos',3,1,2);
...
INSERT INTO `orders_details` VALUES (223,12,18,125),(224,9,18,10),(225,7,20,15),(228,7,19,12),(229,9,19,12),(235,10,24,25),(236,1,24,5),(237,5,46,10),(238,10,46,15),(241,5,60,10),(243,1,60,15),(244,5,61,3),(246,6,61,2),(247,1,61,6),(249,10,25,60);
...
CREATE TABLE `users` (
  ...
  `birth_date` varchar(45) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `users` VALUES (14,'Esteban','Marín',NULL,'116380004',NULL,NULL,'admin@logistica.com','$2a$08$FpNWx9YyfP37kVVjH3huverAX4Wchb8rVnRYu79CUaoMryfkolRzO',3),(15,'Thalia','Alcivar',NULL,'22464804','22735126','1985-10-05','ravicla1993@hotmail.com','$2a$08$BfIZ2d5E/TcSL8Nb/al6FuXN4P.vxudbtMXk/S.pYmN77d0F3vXku',1),(17,'Juan','Barrera',NULL,'115380540',NULL,'1978-10-05','bjuancarlos886@gmail.com','$2a$08$Wkow2Z65VftF5rSmkCESdestTDmYiTEjoaMK5VKA.q1gIGdT47ETu',2),(23,'Luis','Marín','Murillo','22464806','85748980','1987-10-10','yiyomarin@gmail.com','$2a$08$u3ew6ZAunjFBZRyeNN8ZNOQm6NuekEUV/PruO1oL6Y9LiJj8lOEMS',1),(25,'María Jesús','Chanto','Mora','115380545','87268678','1993-06-17','maria_chanto@hotmail.com','$2a$08$V.Aofia3lKRH9Byec0NcQeLFGP13l6EZ853JhxEDp2X5KVgfrBa9K',2);
...
INSERT INTO `users_warehouses` VALUES (83,15,1),(40,17,2),(67,23,1),(68,23,2),(84,25,1),(85,25,9);
...
INSERT INTO `warehouses` VALUES (1,'Almacén 1','San José, Curridabat, Granadilla Norte'),(2,'Almacén 2','Bogotá, Bogotá'),(9,'Almacén 3','Madrid, Calle 55');
...
-- Dump completed on 2022-12-11 23:05:05
